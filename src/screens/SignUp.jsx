...
const SignUp = () => {
  ...
  const submitBtnStyle = {
    width: '100%',
    backgroundColor: '#8B8E9D', // Exact purple/gray from design
    color: '#FFFFFF',
    border: 'none',
    borderRadius: '24px',
    height: '52px',
    ...
    <div style={containerStyle}>
      <div style={cardStyle}>
        ...
        <form style={{ width: '100%' }} onSubmit={(e) => { e.preventDefault(); navigate('/'); }}>
          ...
          <div style={inputGroupStyle}>
            ...
            <div style={inputContainerStyle}>
              {/* No icon for Name field as per design */}
              <input 
                type="text" 
        ...
        <div style={footerTextStyle}>
          Already have an account? <Link to="/signin" style={footerLinkStyle}>Sign in</Link>
        </div>
